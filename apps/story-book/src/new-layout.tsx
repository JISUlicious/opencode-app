...
export default function NewLayoutApp() {
  ...
  const tabDescription = (tab: SettingsTab) => {
    switch (tab) {
      case "den":
        return "Manage your WorkspaceAgent Cloud connection, hosted workers, and workspace access.";
      case "model":
      ...
      case "appearance":
        return "Adjust how WorkspaceAgent looks across desktop, system theme, and app chrome.";
      case "updates":
      ...
      default:
        return "Connect providers, authorize folders, and control the active WorkspaceAgent workspace.";
    }
  };
  ...
  const mockOpenworkServerClient = {
    ...
    getOpenCodeRouterTelegram: async () => ({
      ...
      bot: { id: 1, username: "openwork_storybot", name: "WorkspaceAgent Story Bot" },
    }),
  ...
  const pickMockWorkspaceFolder = async () => {
    const folders = [
      "/Users/demo/WorkspaceAgent/client-foundation",
      "/Users/demo/WorkspaceAgent/automation-lab",
      "/Users/demo/WorkspaceAgent/starter-sandbox",
    ];
                    ...
                    <div class="min-w-0 space-y-6">
                      ...
                      <Show when={settingsTab() === "skills"}>
                        <div class="rounded-[20px] border border-dls-border bg-dls-surface p-6 text-[14px] text-dls-secondary">
                          ...
                          Use the WorkspaceAgent app shell to exercise this surface.
                        </div>
                      </Show>
