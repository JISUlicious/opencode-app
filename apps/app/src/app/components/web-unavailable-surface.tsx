...
const MESSAGE =
  "This feature is currently unavailable in WorkspaceAgent Web, check WorkspaceAgent Desktop for full functionality.";
      ...
      <Show when={props.unavailable}>
        ...
        >
          <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
            <span>{MESSAGE}</span>
            <a
              href="https://github.com/jisulicious/opencode-app/releases"
              target="_blank"
              rel="noreferrer"
              class="inline-flex items-center gap-1 underline underline-offset-2 hover:no-underline"
            >
              <span>Download WorkspaceAgent Desktop</span>
