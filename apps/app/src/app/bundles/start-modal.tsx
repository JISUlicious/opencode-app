              ...
              <div class="flex min-w-0 items-start gap-3">
                ...
                <div class="min-w-0">
                  ...
                  <p class="mt-1 text-sm leading-relaxed text-dls-secondary">
                    {props.description?.trim() || "Pick a folder and WorkspaceAgent will create a workspace from this template."}
                  </p>
                </div>
              </div>
              <button
          ...
          <div class="space-y-4 px-6 py-6">
            <div class="rounded-2xl border border-dls-border bg-dls-sidebar px-5 py-4">
              ...
              <p class="mt-1 text-sm text-dls-secondary">
                Choose where this template should live. WorkspaceAgent will create the workspace and bring in the template automatically.
              </p>
