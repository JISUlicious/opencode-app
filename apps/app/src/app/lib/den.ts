...
const STORAGE_BASE_URL = "workspaceagent.den.baseUrl";
const STORAGE_API_BASE_URL = "workspaceagent.den.apiBaseUrl";
const STORAGE_AUTH_TOKEN = "workspaceagent.den.authToken";
const STORAGE_ACTIVE_ORG_ID = "workspaceagent.den.activeOrgId";
const STORAGE_ACTIVE_ORG_SLUG = "workspaceagent.den.activeOrgSlug";
const STORAGE_ACTIVE_ORG_NAME = "workspaceagent.den.activeOrgName";
const DEFAULT_DEN_TIMEOUT_MS = 12_000;

export const DEFAULT_DEN_AUTH_NAME = "WorkspaceAgent User";
