...
const STORAGE_URL_OVERRIDE = "workspaceagent.server.urlOverride";
const STORAGE_PORT_OVERRIDE = "workspaceagent.server.port";
const STORAGE_TOKEN = "workspaceagent.server.token";
const STORAGE_REMOTE_ACCESS = "workspaceagent.server.remoteAccessEnabled";
...
function buildHeaders(
  ...
  if (hostToken) {
    headers["X-WorkspaceAgent-Host-Token"] = hostToken;
  }
  if (extra) {
