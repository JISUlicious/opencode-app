...
const LEFT_SIDEBAR_WIDTH_KEY = "workspaceagent.workspace-shell.left-width.v1";
const RIGHT_SIDEBAR_EXPANDED_KEY = "workspaceagent.workspace-shell.right-expanded.v3";
