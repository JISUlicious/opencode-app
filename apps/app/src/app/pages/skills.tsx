...
import { saveInstalledSkillToWorkspaceAgentOrg } from "../bundles/skill-org-publish";
...
export default function SkillsView(props: SkillsViewProps) {
  ...
  const publishSkillToTeam = async () => {
    ...
    try {
      ...
      const { orgName, orgId } = await saveInstalledSkillToWorkspaceAgentOrg({
                        ...
                        <div class="min-w-0 flex-1">
                          <div class="flex flex-wrap items-center gap-2">
                            ...
                            <Show when={isOpenworkInjectedSkill(skill)}>
                              <span class={tagClass}>WorkspaceAgent</span>
                            </Show>
                          </div>
