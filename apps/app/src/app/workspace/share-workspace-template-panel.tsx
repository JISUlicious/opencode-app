    ...
    <Show when={sensitiveWarnings().length > 0}>
      <div class={warningBannerClass}>
        ...
        <div class="mt-1 text-[12px] leading-relaxed text-dls-secondary">
          WorkspaceAgent found config that can expose secrets, remote endpoints, or persistence points. Choose how to handle it before publishing.
        </div>
  ...
  return (
    <>
        ...
        <div class="space-y-4 pt-2 animate-in fade-in slide-in-from-right-4 duration-300">
          ...
          <div class="space-y-4">
            <WorkspaceOptionCard
              ...
              description="Save this workspace template to your active WorkspaceAgent Cloud organization."
              icon={Users}
      ...
      <Show when={props.view === "template-team"}>
        <div class="space-y-5 pt-2 animate-in fade-in slide-in-from-right-4 duration-300">
          <div class="text-[14px] leading-relaxed text-dls-secondary">
            Save this template to your active WorkspaceAgent Cloud organization so teammates can open it later from Cloud settings.
          </div>
          ...
          <div class={surfaceCardClass}>
            ...
            <Show when={needsSignIn}>
              <div class="mt-3 text-[12px] text-dls-secondary">WorkspaceAgent Cloud opens in your browser and returns here after sign-in.</div>
            </Show>
