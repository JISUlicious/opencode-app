...
export const MODEL_PREF_KEY = "workspaceagent.defaultModel";
export const SESSION_MODEL_PREF_KEY = "workspaceagent.sessionModels";
export const THINKING_PREF_KEY = "workspaceagent.showThinking";
export const VARIANT_PREF_KEY = "workspaceagent.modelVariant";
export const LANGUAGE_PREF_KEY = "workspaceagent.language";
export const HIDE_TITLEBAR_PREF_KEY = "workspaceagent.hideTitlebar";
