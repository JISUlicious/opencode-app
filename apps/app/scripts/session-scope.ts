...
const starterRoot = "/Users/test/WorkspaceAgent/starter";
const otherRoot = "/Users/test/WorkspaceAgent/second";
...
try {
  ...
  await step("windows create and list use the same transport directory", () => {
    ...
    const winRoot = String.raw`C:\Users\Test\WorkspaceAgent\starter`;
    ...
    const verbatimDriveRoot = String.raw`\\?\C:\Users\Test\WorkspaceAgent\starter`;
    assert.equal(toSessionTransportDirectory(verbatimDriveRoot), String.raw`C:\Users\Test\WorkspaceAgent\starter`);
  ...
  await step("round-trip invariant: every query path equals the create path (unix)", () => {
    ...
    const unixPaths = [
      "/Users/test/WorkspaceAgent/starter",
      "/Users/test/WorkspaceAgent/starter/",
  ...
  await step("round-trip invariant: every query path equals the create path (windows)", () => {
    ...
    const windowsPaths = [
      "C:\\Users\\Test\\WorkspaceAgent\\starter",
      "C:\\Users\\Test\\WorkspaceAgent\\starter\\",
      "D:\\projects\\my-app",
